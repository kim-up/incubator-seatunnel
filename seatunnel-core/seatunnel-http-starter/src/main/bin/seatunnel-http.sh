...
APP_JAR=${APP_DIR}/starter/seatunnel-http-starter.jar
APP_MAIN="org.apache.seatunnel.core.starter.seatunnel.http.Application"
OUT="${APP_DIR}/logs/seatunnel-http-client.out"
HELP=false

if [ -f "${CONF_DIR}/seatunnel-http-env.sh" ]; then
    . "${CONF_DIR}/seatunnel-http-env.sh"
fi
